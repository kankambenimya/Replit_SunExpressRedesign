            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <PassengerDropdown
                  ...
                  onPassengerChange={(type: "adults" | "children" | "infants", value: number) => form.setValue(type, value)}
                  onClassChange={(value: string) => form.setValue("seatClass", value as "economy" | "business")}
                />
              </div>
            </div>
